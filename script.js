...
// Function to create a cloud element and add it to the container with random positions, animation properties, and image
function createCloud() {
    ...
    cloudImg.style.animationDuration = "10s";
